...
public class Btn_Agri_Spm_Activity extends AppCompatActivity {
    ImageView backBtn, basicarrow, dcnarrow;
    Button b1, b2, b3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn_agri_spm);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Btn_Agri_Spm_Activity.super.onBackPressed();
            ...
            mStorageReference.getFile(localFile)
                    .addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(Btn_Agri_Spm_Activity.this, "Image load successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull @NotNull Exception e) {
                    Toast.makeText(Btn_Agri_Spm_Activity.this, "Unable to load image", Toast.LENGTH_SHORT).show();
                }
            });
        } catch (IOException e) {
            e.printStackTrace();
        ...
        basicarrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance().getReference("pdf/agri_spm");
