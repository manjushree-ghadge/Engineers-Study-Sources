...
public class Btn_Mech_Md_Activity extends AppCompatActivity {
    ImageView backBtn, gfgarrow, tutarrow, guruarrow, basicarrow, dcnarrow,shortnotearrow;
    Button b1, b2, b3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn_mech_md);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Btn_Mech_Md_Activity.super.onBackPressed();

            }
        });
        //links activity
        StorageReference mStorageReference = FirebaseStorage.getInstance().getReference().child("mechanical_logo/bright_hub.png");
        try {
            final File localFile = File.createTempFile("bright_hub", "png");
            mStorageReference.getFile(localFile)
                    .addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                        @Override
                        public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(Btn_Mech_Md_Activity.this, "Image load successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull @NotNull Exception e) {
                    Toast.makeText(Btn_Mech_Md_Activity.this, "Unable to load image", Toast.LENGTH_SHORT).show();
                }
            });
        } catch (IOException e) {
            e.printStackTrace();
        ...
        gfgarrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance().getReference("mech_md");
                firebaseDatabase.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        String url = "" + snapshot.child("url_bright").getValue();
                        gotourl(url);
                    }
        ...
        mStorageReference = FirebaseStorage.getInstance().getReference().child("mechanical_logo/science_direct.png");
        try {
        ...
        guruarrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                firebaseDatabase.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        String url = "" + snapshot.child("url_science").getValue();
                        gotourl(url);
                    }
        ...
        basicarrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance().getReference("pdf/mech_md");
                firebaseDatabase.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
