...
public class Btn_Electronics_Dc_Activity extends AppCompatActivity {
    ImageView backBtn, gfgarrow, tutarrow, guruarrow,  basicarrow, lecturearrow, dcnarrow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn_electronics_dc);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Btn_Electronics_Dc_Activity.super.onBackPressed();
            ...
            mStorageReference.getFile(localFile)
                    .addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(Btn_Electronics_Dc_Activity.this, "Image load successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull @NotNull Exception e) {
                    Toast.makeText(Btn_Electronics_Dc_Activity.this, "Unable to load image", Toast.LENGTH_SHORT).show();
                }
            });
        } catch (IOException e) {
            e.printStackTrace();
        ...
        gfgarrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance().getReference("electronics_dc");
        ...
        basicarrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance().getReference("pdf/electronics_dc");
                firebaseDatabase.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
