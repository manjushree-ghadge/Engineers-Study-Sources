...
public class Btn_Mech_Dom_Activity extends AppCompatActivity {
    ImageView backBtn, gfgarrow, basicarrow, lecturearrow, dcnarrow;
    Button b1, b2, b3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_btn_mech_dom);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Btn_Mech_Dom_Activity.super.onBackPressed();

            }
        });
        //links activity
        StorageReference mStorageReference = FirebaseStorage.getInstance().getReference().child("mechanical_logo/nptel.png");
        try {
            ...
            mStorageReference.getFile(localFile)
                    .addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(Btn_Mech_Dom_Activity.this, "Image load successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull @NotNull Exception e) {
                    Toast.makeText(Btn_Mech_Dom_Activity.this, "Unable to load image", Toast.LENGTH_SHORT).show();
                }
            });
        } catch (IOException e) {
            e.printStackTrace();
        ...
        gfgarrow.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance().getReference("mech_dom");
        ...
        basicarrow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatabaseReference firebaseDatabase = FirebaseDatabase.getInstance().getReference("pdf/mech_dom");
                firebaseDatabase.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
